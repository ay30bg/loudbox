...
const mockEvents = [
  {
    ...
    subaccount_code: 'ACCT_correct_code_here', // Replace with valid Paystack subaccount code
  ...
  },
  {
    ...
    subaccount_code: 'ACCT_correct_code_here',
    venue: 'Ziggo Dome',
    city: 'Amsterdam',
    category: 'Concert',
    month: 'DEC',
  ...
  },
  {
    ...
    year: '2025',
    time: '17:00',
    about: 'Burna Boy Live: 2025 Tour Heats Up! The African Giant brings his electrifying energy to the Stade de France on April 18...',
...
function OrderSummary({ navigateBack, navigateToThankYou }) {
  ...
  const {
    ...
    ticketQuantity = 1,
    totalPrice = eventData?.basePrice || 0,
    isGift = false,
    recipientFirstName = '',
    recipientLastName = '',
    recipientEmail = '',
  ...
  const createTicket = async (response) => {
    try {
      ...
      navigateToThankYou(id, {
        state: {
          ...ticketData,
          transactionReference: ticketResult.data.transactionReference,
  ...
  const handlePayment = async () => {
    ...
    try {
        ...
        metadata: {
          custom_fields: [
            ...
            },
            {
              ...
              value: `${firstName} ${lastName}`.trim() || 'Guest',
            },
            {
            ...
            },
            {
              ...
              value: eventData?.subaccount_code || 'N/A',
            },
          ],
        },
      };
      ...
      if (!paystackData.email || !paystackData.amount || paystackData.amount <= 0) {
        throw new Error('Invalid payment data: email and positive amount are required');
      }
